...
public class AdminControllerTest {
    ...
    @DisplayName("회원가입 없이 /admin API 호출 시 401 응답 확인")
    @Test
    ...
    @DisplayName("일반 회원가입 후 토큰을 담아 /admin API 호출 시 403 응답 확인")
    @Test
    ...
    @DisplayName("ROLE_MANAGER 회원가입 후 토큰을 담아 /admin API 호출 시 403 응답 확인")
    @Test
    ...
    @DisplayName("ROLE_ADMIN 회원가입 후 토큰을 담아 /admin API 호출 시 200 응답 확인")
    @Test
